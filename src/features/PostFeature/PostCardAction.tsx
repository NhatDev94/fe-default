  ...
  return (
    <div className="px-4">
      ...
      <div className="flex items-center justify-between py-1 gap-x-1">
        ...
        <div className="flex items-center justify-center w-40 h-8 hover:bg-hover rounded-md cursor-pointer">
          <p className="text-xs font-semibold">{faMessageIcon}<span className="ml-1.5">Thich</span></p>
        </div>
        <div className="flex items-center justify-center w-40 h-8 hover:bg-hover rounded-md cursor-pointer">
          <p className="text-xs font-semibold">{faShareIcon}<span className="ml-1.5">Thich</span></p>
        </div>
      </div>
    </div>
  )
