    ...
    return (
        <div className='w-screen h-screen fixed top-0 left-0 z-[99]'>
            <div className='w-full h-full relative'>
                <div className='w-full h-full z-50 bg-black/20 absolute top-0 left-0' onClick={handleClose}></div>
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-md py-2 px-4 w-2/5 min-w-[240px] min-h-[20%]'>
                    <div className='w-full h-full relative'>
                        {isLoading && <div className='absolute top-0 left-0 z-50 bg-white/60 w-full h-full flex items-center justify-center'>...loading</div>}
